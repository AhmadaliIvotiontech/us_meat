function validateForm() 
    {
        ...
        if(tooltip_img == ""){
            document.getElementById("tooltip_img-error").innerHTML="Please Select Banner Tradmark Image";
        ...
        var tooltip_txt=$("#tooltip_txt");
        if(tooltip_txt.val() == "")
        {
            document.getElementById("tooltip_txt-error").innerHTML="Please Enter Banner Button text";
        ...
        // if(description == "")
        // {
        //     document.getElementById("descriptionCheck").innerHTML="Please Enter Category Description";
        //     document.getElementById("descriptionCheck").style.color="red";
        //     valid = false;
        // }else{
