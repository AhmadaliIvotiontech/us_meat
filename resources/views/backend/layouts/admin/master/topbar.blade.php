        ...
        <div class="navbar-header" style="text-align: center;">
            <a class="navbar-brand" href="{{ url('/') }}" target="_blank">
                <!-- Logo icon --><b>
                    ...
                    <!-- Dark Logo icon -->
                    {{-- <img src="{{asset('public/frontend/images/header-logo-black.png')}}" alt="homepage" class="dark-logo" /> --}}
                    <!-- Light Logo icon -->
                    {{-- <img src="{{asset('public/frontend/images/header-logo-black.png')}}" alt="homepage" class="light-logo" /> --}}
                </b>
                <!--End Logo icon -->
                <!-- Logo text --><span>
                 <!-- dark Logo text -->
                 {{-- <img src="{{asset('public/backend/images/logo.png')}}" alt="homepage" class="dark-logo" /> --}}
                 <!-- <img src="{{asset('public/backend/images/logo.png')}}" alt="homepage" class="dark-logo" 
                 style="width: 150px;height:100%;padding-top: 10px;"/> -->
                 <!-- <h2 style="color:#000">US MEAT</h2> -->
                 <!-- Light Logo text -->    
                 {{-- <img src="{{asset('public/frontend/images/header-logo-black.png')}}" class="light-logo" alt="homepage" /></span> </a> --}}
        </div>
        <!-- ============================================================== -->
        <!-- End Logo -->
        <!-- ============================================================== -->
