                            ...
                            <div id="ShowHide" style="display:none">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" id="temp_banner_img" class="form-control" name="temp_banner_img">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" id="temp_banner_bg_img" class="form-control" name="temp_banner_bg_img">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" id="temp_video_img" class="form-control" name="temp_video_img">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" id="temp_ingredientes_img" class="form-control" name="temp_ingredientes_img" >
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" id="temp_preparation_img" class="form-control" name="temp_preparation_img" >
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" id="temp_preparation_img_full" class="form-control" name="temp_preparation_img_full">
