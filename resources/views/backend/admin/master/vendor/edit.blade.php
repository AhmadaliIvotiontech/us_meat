...
@section('content')
<script src="{{ asset('public/backend/assets/admin/master/vendor/edit.js') }}" type="text/javascript"></script>
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="post" id="UpdateVendorForm" action="{{ route('UpdateVendorPost') }}">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label">Name</label>
                                    <input type="text" id="name" name="name" class="form-control" value="{{ $vendor->name }}"  placeholder="Enter Name">
                                    <input type="hidden" id="id" name="id" class="form-control" value="{{ $vendor->id }}"  placeholder="Enter Name">
                                    <label id="nameCheck" />
                                </div>
                            </div>
                            <!--/span-->
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="email" name="email" class="form-control " value="{{ $vendor->email }}" placeholder="Enter Email">
                                    <input type="hidden" id="email_temp" name="email_temp" class="form-control " value="{{ $vendor->email }}" >
                                    <input type="hidden" id="email_exist" name="email_exist" class="form-control " value="{{ $vendor_all }}">
                                    <label id="emailCheck" />
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="custom-control custom-radio">
                                    ...
                                    <input type="hidden" id="status_temp" name="status_temp" class="form-control" value="{{ $vendor->status }}">
                                </div>
                            </div>
                        </div>
                        <div class="row">
