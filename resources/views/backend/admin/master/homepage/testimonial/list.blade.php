        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="{{ route('add_testimonial_master') }}"><button type="button" class="btn waves-effect waves-light btn-rounded btn-danger text-white text-end" style="float: right;margin-bottom: 20px;">+ Add Testimonials</button></a>
                        ...
                        <table class="nowrap table table-hover border dataTable no-footer" id="listBrands">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ $i }}</td>
                                    <td>{{ $item->text_1 }}</td>
                                    <?php $url = 'storage/app/backend/homepage/testimonial/'.$item['img'];  ?>
                                    ...
                                    <td>
                                        <a href="{{ url('admin/master/edit-testimonial/'.$item->id) }}" class="text-inverse p-r-10" data-bs-toggle="tooltip" title="" data-original-title="Edit"><i class="fas fa-edit"></i></a> 

                                        <a href="{{ url('admin/master/delete-testimonial/'.$item->id) }}" class="text-inverse" title="" data-bs-toggle="tooltip" data-original-title="Delete"><i class="mdi mdi-delete-forever" style="font-size: 15px;"></i></a>
                                    </td>
                                </tr>
                                <?php $i++; ?>
                                @endforeach
