                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="text_1" name="text_1" class="form-control "  placeholder="Enter Banner título 1" value="{{ $banner->text_1 }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="text_2" name="text_2" class="form-control "  placeholder="Enter Banner título 2" value="{{ $banner->text_2 }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="text_3" name="text_3" class="form-control "  placeholder="Enter Subtitulo o Eslogan" value="{{ $banner->text_3 }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" id="temp_tooltip_img" class="form-control" name="temp_tooltip_img" value="{{ $banner->tooltip_img }}">
                                    <label id="tooltip_img-error" />
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group" style="text-align: center;">  
                                    <?php $url = 'storage/app/backend/homepage/banner/'.$banner['tooltip_img'];  ?>
                                    <img src="{{ asset($url) }}" style="height: 100px; background: #000000;padding: 10px;width: 250px;">
                                    <span class="label label-rounded label-inverse">Current Image</span>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="tooltip_txt" name="tooltip_txt" class="form-control "  placeholder="Enter Texto del tooltip" value="{{ $banner->tooltip_txt }}">
