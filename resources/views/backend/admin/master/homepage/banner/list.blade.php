        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="{{ route('add_banner_master') }}"><button type="button" class="btn waves-effect waves-light btn-rounded btn-danger text-white text-end" style="float: right;margin-bottom: 20px;">+ Add Banner</button></a>
                        ...
                        <table class="nowrap table table-hover border dataTable no-footer" id="listBrands">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ $i }}</td>
                                    <td>{{ $item->text_1 }}</td>
                                    <?php $url = 'storage/app/backend/homepage/banner/'.$item['banner_main_img'];  ?>
                                    ...
                                    <td>
                                        <a href="{{ url('admin/master/edit-banner/'.$item->id) }}" class="text-inverse p-r-10" data-bs-toggle="tooltip" title="" data-original-title="Edit"><i class="fas fa-edit"></i></a> 

                                        <a href="{{ url('admin/master/delete-banner/'.$item->id) }}" class="text-inverse" title="" data-bs-toggle="tooltip" data-original-title="Delete"><i class="mdi mdi-delete-forever" style="font-size: 15px;"></i></a>
                                    </td>
                                </tr>
                                <?php $i++; ?>
                                @endforeach
