...
@section('content')
<script src="{{ asset('public/backend/assets/admin/subadmin/profile.js') }}" type="text/javascript"></script>
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="post" id="UserUpdateForm" action="{{ route('SubAdmin_updateProfile') }}">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
          <form class="form-horizontal form-material" id="changePasswordForm" method="post" action="{{ route('SubAdmin_updatePwd') }}">
                @csrf
